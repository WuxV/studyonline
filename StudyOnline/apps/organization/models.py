...
class CourseOrg(models.Model):
    ...
    category = models.CharField(default="org", max_length=20, verbose_name=u"机构类别", choices=(("org", u"培训机构"),("per", u"个人"),("uni", u"高校")))
    ...
    def get_classic_courses(self):
        return self.course_set.order_by('-click_nums')[:2]

class Teacher(models.Model):
    org = models.ForeignKey(CourseOrg, verbose_name=u"所属机构")
    name = models.CharField(max_length=50, verbose_name=u"教师名称")
    age = models.IntegerField(default=18, verbose_name=u"教师年龄")
